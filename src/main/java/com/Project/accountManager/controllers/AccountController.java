...
public class AccountController {
    ...
    public Account updateAccount(@PathVariable Long accountId, @RequestBody AccountUpdateRequest accountUpdateRequest){
        return accountService.updateOneAccount(accountId,accountUpdateRequest);
    }
